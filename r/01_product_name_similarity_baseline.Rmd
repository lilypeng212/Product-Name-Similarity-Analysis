---
"Product Name Similarity Analysis — Baseline"
...
上架商品_1P <- read_excel("C:/Users/Lily Peng/Downloads/有售商品.xlsx")


上架新品_3P <- read_excel("C:/Users/Lily Peng/Downloads/3有售商品.xlsx")
...
write.xlsx(df_best_match_2, "商品相似度分析_3P有售商品.xlsx", overwrite = TRUE)
```
...
# ✅ **儲存結果到 Excel**
write.xlsx(df_best_match_3, "商品相似度分析_3P有售商品_New.xlsx", overwrite = TRUE)
```
